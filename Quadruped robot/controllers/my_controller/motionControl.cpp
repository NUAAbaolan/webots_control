...
void MotionControl::inverseKinematics()
{
    ...
    jointCmdPos[0] = motorInitPos[0];
    jointCmdPos[1] = motorInitPos[1];
    jointCmdPos[2] = motorInitPos[2];
    jointCmdPos[3] = motorInitPos[3];
    jointCmdPos[4] = motorInitPos[4];
    jointCmdPos[5] = motorInitPos[5];
    jointCmdPos[6] = motorInitPos[6];
    jointCmdPos[7] = motorInitPos[7];
    jointCmdPos[8] = motorInitPos[8];
    jointCmdPos[9] = motorInitPos[9];
    jointCmdPos[10] = motorInitPos[10];
    jointCmdPos[11] = motorInitPos[11];
